...
namespace Drones.Controllers
{
    public class SupervisorsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Supervisor supervisor = (Supervisor)db.Users.Find(id);
            if (supervisor == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Password,Email,TelephoneNumber")] Supervisor supervisor)
        {
            if (ModelState.IsValid)
            {
